        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6 text-foreground/80 leading-relaxed text-lg">
            {lang === "hi" ? (
              <>
                <p>
                  <strong>परमहंस श्री स्वामी स्वरूपानंद सरस्वती जी महाराज</strong> 
                  जगद्गुरु शंकराचार्य परंपरा के प्रतिष्ठित आचार्य थे। 
                  उनका जन्म <strong>2 सितम्बर 1924</strong> को हुआ था और 
                  <strong>11 सितम्बर 2022</strong> को वे शिवतत्व में विलीन हो गए।
                </p>
