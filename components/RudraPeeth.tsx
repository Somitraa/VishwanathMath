...
export default function RudraPeeth() {
  ...
  return (
    <section id="rudra" className="py-20 md:py-32 bg-background border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-primary mb-4">🕉️ एकादश रुद्र पीठ</h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            विश्वनाथ मठ परिसर में स्थित <span className="font-semibold text-primary"> एकादश रुद्र पीठ </span> भगवान शिव के ग्यारह दिव्य रूपों को समर्पित है —
            जो सृष्टि, पालन और संहार के विभिन्न आयामों का प्रतिनिधित्व करते हैं।
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {rudras.map((rudra, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-primary text-center mb-2">{rudra.name}</h3>
              <p className="text-foreground/80 text-center">{rudra.description}</p>
            </div>
          ))}
        </div>
        </center>
        ...
        <div className="mt-16 p-8 rounded-xl bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/20 text-center">
          <p className="text-lg text-foreground">
            यह पीठ <strong>भगवान रुद्र</strong> के ग्यारह रूपों के माध्यम से आध्यात्मिक शक्ति, शांति और आत्मज्ञान की साधना का
            केंद्र है।
          </p>
        </div>
      </div>
